-- Hotel segment: dedicated adjustment table (mirrors package_booking_adjustments)
...
-- Migrate existing hotel rows from shared booking_adjustments
INSERT INTO hotel_booking_adjustments (
