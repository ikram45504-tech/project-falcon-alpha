-- Misc segment: dedicated adjustment table (mirrors hotel_booking_adjustments / ticket_booking_adjustments)
...
-- Migrate existing misc rows from shared booking_adjustments
INSERT INTO misc_booking_adjustments (
