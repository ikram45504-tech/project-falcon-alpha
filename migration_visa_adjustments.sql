-- Visa segment: dedicated adjustment table (mirrors hotel_booking_adjustments / ticket_booking_adjustments)
...
-- Migrate existing visa rows from shared booking_adjustments
INSERT INTO visa_booking_adjustments (
