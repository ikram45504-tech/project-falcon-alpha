  ...
  if (service === "PACKAGE")
    return (
      <svg {...common}>
        ...
        <path d="M5 11h14M9 11v2M15 11v2" />
      </svg>
    );
  if (service === "TICKET")
    return (
      <svg {...common}>
        <path d="M4 8.5A2.5 2.5 0 0 0 6.5 6h11.2A1.3 1.3 0 0 1 19 7.3V10a2 2 0 0 0 0 4v2.7a1.3 1.3 0 0 1-1.3 1.3H6.5A2.5 2.5 0 0 0 4 15.5z" />
        <path d="M13 8.5v1M13 12v1M13 15.5v1" />
      </svg>
    );
  if (service === "HOTEL")
    return (
      <svg {...common}>
        ...
        <path d="M16 9h2.5A1.5 1.5 0 0 1 20 10.5V20M3 20h18" />
        <path d="M8 8h2M8 11h2M8 14h2M13 8h1M13 11h1M13 14h1" />
      </svg>
    );
  if (service === "VISA")
    return (
  ...
  if (service === "TRANSPORT")
    return (
      <svg {...common}>
        ...
        <path d="M7 18v2M17 18v2M4 13h16M7 8h4M14 8h3" />
...
export default function BookingsModule({
        ...
        <div className="booking-direction-grid">
          <button type="button" className="booking-direction-card sale" onClick={() => chooseDirection("SALE")}>
            ...
            <div>
              <small>SALE</small>
              <b>Sale to Party</b>
              <p>Create a booking sold to a Party / customer account.</p>
            </div>
          ...
          <button type="button" className="booking-direction-card purchase" onClick={() => chooseDirection("PURCHASE")}>
            ...
            <div>
              ...
              <b>Purchase from Vendor / Supplier</b>
              <p>Record a booking purchased from a Vendor / supplier account.</p>
            </div>
            <span className="direction-arrow">→</span>
          </button>
        </div>
      ...
      <section className="booking-entry-screen booking-services-screen">
        <div className="booking-screen-toolbar">
          ...
          <div className="bf-toolbar-actions">
            <span className={`direction-badge ${transactionType === "SALE" ? "sale" : "purchase"}`}>
              {transactionType === "SALE" ? "SALE TO PARTY" : "PURCHASE FROM VENDOR / SUPPLIER"}
            </span>
          </div>
        </div>
  ...
  return (
    <section className="content-card bookings-page bookings-flow-v2">
      ...
      {screen === "SERVICE_FORM" && service === "TRANSPORT" && sharedProps && (
        <TransportBookingModule {...sharedProps} />
      )}
