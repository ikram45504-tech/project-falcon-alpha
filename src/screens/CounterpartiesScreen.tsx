  ...
  return (
    <section className="booking-entry-screen booking-direction-screen">
      ...
      {unassignedAccounts.length > 0 && can("view_parties") && (
        <div style={{ backgroundColor: "#fff3cd", border: "1px solid #ffeeba", borderRadius: "8px", padding: "16px", marginBottom: "24px", color: "#856404", display: "flex", justifyContent: "space-between", alignItems: "center", maxWidth: "800px", margin: "0 auto 24px auto" }}>
          <div>
            <strong>Action Required:</strong> You have {unassignedAccounts.length} account(s) that need classification (Party vs Vendor).
          </div>
          <button className="primary small warning" style={{ backgroundColor: "#856404" }} onClick={() => navigate("/parties/UNASSIGNED")}>Review Accounts</button>
        </div>
      )}
          ...
          <button type="button" className="booking-direction-card sale" onClick={() => navigate("/parties/PARTY")}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
                ...
                <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--brand-secondary)", background: "var(--bg-app)", padding: "2px 8px", borderRadius: "12px" }}>{partyAccounts.length} ACTIVE</span>
              </div>
          ...
          <button type="button" className="booking-direction-card purchase" onClick={() => navigate("/parties/VENDOR")}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "4px" }}>
                ...
                <span style={{ fontSize: "11px", fontWeight: 800, color: "var(--red)", background: "var(--bg-app)", padding: "2px 8px", borderRadius: "12px" }}>{vendorAccounts.length} ACTIVE</span>
              </div>
