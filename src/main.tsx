...
function renderSafetyFailure(error: unknown) {
  ...
  ReactDOM.createRoot(document.getElementById("root") as HTMLElement).render(
    <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: 32, fontFamily: "system-ui, sans-serif", background: "#f5f7fa" }}>
      <section style={{ maxWidth: 680, background: "white", border: "1px solid #d9e0e8", borderRadius: 14, padding: 28, boxShadow: "0 12px 36px rgba(30, 50, 70, 0.08)" }}>
        ...
        <p style={{ margin: "0 0 10px", lineHeight: 1.55 }}>The app stopped before normal database initialization so existing accounting data is not exposed to an unsafe startup path.</p>
