-- Transport segment: dedicated adjustment table (mirrors hotel_booking_adjustments / ticket_booking_adjustments)
...
-- Migrate existing transport rows from shared booking_adjustments
INSERT INTO transport_booking_adjustments (
